...
function receivedMessage(event) {
  ...
  if (messageText) {
    ...
    switch (messageText.replace(/[^\w\s]/gi, '').trim().toLowerCase()) {
      ...
      case 'how are you':
        sendKimMessage(senderID);
        break;
      case 'announce Prem':
        announcePrem(senderID);
        break;
      case 'image':
...
function sendKimMessage(recipientId) {
  var messageData = {
    recipient: {
      id: recipientId
    },
    message: {
      text: kimQuotes[Math.floor(Math.random()*kimQuotes.length)]
    }
  }
...
function announcePrem(recipientId) {
  var messageData = {
    recipient: {
      id: recipientId
    },
    message: {
      text: "Prem of the House Anandan, the First of His Name, The Unburnt, King of the Offshore, the Clarksons and the First Men, King of Marine, Khaleesi of the Great Grass Sea, Protector of the Docks, Gentleman Regnant of the Seven Kingdoms, Breaker of Chains and Father of Dragons"
    }
  }
